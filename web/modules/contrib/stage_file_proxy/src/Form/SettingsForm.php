...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $field_type = NULL): array {
    ...
    $form['origin'] = [
      ...
      '#description' => $this->t("The origin website. For example, 'https://example.com.' If the site is using HTTP Basic Authentication (the browser popup for username and password), you can embed those in the url. Be sure to URL encode any special characters:<br/><br/>For example, setting a username of 'myusername' and password as, 'letme&in' the configuration would be the following: <br/><br/>'https://myusername:letme%26in@example.com';"),
      '#required' => FALSE,
      '#config' => [
    ...
    $form['proxy_headers'] = [
      ...
      '#description' => $this->t('When Stage File Proxy is configured to transfer the
        ...
        Use format like "Referer|https://example.com/'),
      '#required' => FALSE,
      '#config' => [
